...
- **2026-06-25 update — direction shifting toward kernel MCTP stack.** Analysis
  ...
  A1 / A2 / B. **Decision made 2026-06-25 (commit `0753217`):** Step B/C C++ code
  discarded; pivoting to Option A1 (PTY + `mctp-serial` line discipline).
...
4. Put code in this folder `daryl-mctp-usb-device/` with its own meson.build (C17).
